...
import { BarChart3, DollarSign, Edit2, Eye, Pause, Play, Plus, Search, Trash2, TrendingUp, Upload, Video, X } from "lucide-react";
...
const positionLabels: Record<string, string> = {
  ...
  player: "Player pre-roll",
  popup: "Popup/flutuante",
  footer: "Rodape global",
};
    ...
    <div className="space-y-4">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="text-xs text-gray-400">{loading ? "A carregar anuncios reais..." : `${ads.length} anuncios cadastrados`}</p>
        </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 p-4">
          <div className="max-h-[90vh] w-full max-w-2xl overflow-y-auto rounded-2xl border border-[#2A2A2A] bg-[#1A1A1A]">
            ...
            <div className="space-y-4 p-5">
              ...
              <AdminImageField
                label={form.format === "video" ? "Poster / imagem de fallback" : "Imagem"}
                value={form.imageUrl}
